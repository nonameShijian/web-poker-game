...
-- ----------------------------
INSERT INTO `gen_table` VALUES (1, 'pocker_race_info', '历史比赛信息', NULL, NULL, 'PokerRaceInfo', 'crud', 'com.webPokerGame', 'raceInfoAdmin', 'raceInfoAdmin', '历史比赛信息', 'lwy', '0', '/', '{\"parentMenuId\":\"2000\"}', 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28', NULL);
INSERT INTO `gen_table` VALUES (2, 'pocker_user_game_info', '用户胜负情况', NULL, NULL, 'PokerUserGameInfo', 'crud', 'com.webPokerGame', 'userGameInfo', 'userGameInfo', '用护胜负情况', 'lwy', '0', '/', '{\"parentMenuId\":\"2000\"}', 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19', NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (1, '1', 'id', '信息id', 'int(11)', 'Long', 'id', '1', '1', NULL, '0', '1', '1', '1', 'EQ', 'input', '', 1, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (2, '1', 'race_id', '比赛id', 'int(2)', 'Integer', 'raceId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (3, '1', 'player_a', '玩家A', 'int(2)', 'Integer', 'playerA', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (4, '1', 'player_b', '玩家B', 'int(2)', 'Integer', 'playerB', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (5, '1', 'player_c', '玩家C', 'int(2)', 'Integer', 'playerC', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (6, '1', 'player_d', '玩家D', 'int(2)', 'Integer', 'playerD', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (7, '1', 'winner_a', '胜者A', 'int(2)', 'Integer', 'winnerA', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (8, '1', 'winner_b', '胜者B', 'int(2)', 'Integer', 'winnerB', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 21:59:28');
INSERT INTO `gen_table_column` VALUES (9, '2', 'id', '信息id', 'int(11)', 'Long', 'id', '1', '0', NULL, '0', '1', '1', '1', 'EQ', 'input', '', 1, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19');
INSERT INTO `gen_table_column` VALUES (10, '2', 'user_id', '用户id', 'int(2)', 'Integer', 'userId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19');
INSERT INTO `gen_table_column` VALUES (11, '2', 'win', '胜场次数', 'int(2)', 'Integer', 'win', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19');
INSERT INTO `gen_table_column` VALUES (12, '2', 'lost', '败场次数', 'int(2)', 'Integer', 'lost', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19');
INSERT INTO `gen_table_column` VALUES (13, '2', 'raceNum', '比赛场次', 'int(2)', 'Integer', 'raceNum', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2025-03-15 21:15:20', '', '2025-03-15 22:15:19');

-- ----------------------------
-- Table structure for pocker_race_info
-- ----------------------------
DROP TABLE IF EXISTS `pocker_race_info`;
CREATE TABLE `pocker_race_info`  (
...
-- ----------------------------
-- Records of pocker_race_info
-- ----------------------------

-- ----------------------------
-- Table structure for pocker_user_game_info
-- ----------------------------
DROP TABLE IF EXISTS `pocker_user_game_info`;
CREATE TABLE `pocker_user_game_info`  (
  ...
  `raceNum` int(2) NULL DEFAULT 0 COMMENT '比赛场次',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
-- Records of pocker_user_game_info
-- ----------------------------
...
INSERT INTO `sys_menu` VALUES (2001, '历史比赛信息', 2000, 1, 'raceInfoAdmin', 'raceInfo/raceInfoAdmin/index', NULL, 1, 0, 'C', '0', '0', 'raceInfoAdmin:raceInfoAdmin:list', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '历史比赛信息菜单');
INSERT INTO `sys_menu` VALUES (2002, '历史比赛信息查询', 2001, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'raceInfoAdmin:raceInfoAdmin:query', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2003, '历史比赛信息新增', 2001, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'raceInfoAdmin:raceInfoAdmin:add', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2004, '历史比赛信息修改', 2001, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'raceInfoAdmin:raceInfoAdmin:edit', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2005, '历史比赛信息删除', 2001, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'raceInfoAdmin:raceInfoAdmin:remove', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2006, '历史比赛信息导出', 2001, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'raceInfoAdmin:raceInfoAdmin:export', '#', 'admin', '2025-03-15 21:50:07', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2007, '用护胜负情况', 2000, 1, 'userGameInfo', 'raceInfo/userGameInfo/index', NULL, 1, 0, 'C', '0', '0', 'userGameInfo:userGameInfo:list', '#', 'admin', '2025-03-15 22:16:33', 'admin', '2025-03-15 22:18:33', '用护胜负情况菜单');
INSERT INTO `sys_menu` VALUES (2008, '用护胜负情况查询', 2007, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'userGameInfo:userGameInfo:query', '#', 'admin', '2025-03-15 22:16:33', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2009, '用护胜负情况新增', 2007, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'userGameInfo:userGameInfo:add', '#', 'admin', '2025-03-15 22:16:33', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2010, '用护胜负情况修改', 2007, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'userGameInfo:userGameInfo:edit', '#', 'admin', '2025-03-15 22:16:33', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2011, '用护胜负情况删除', 2007, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'userGameInfo:userGameInfo:remove', '#', 'admin', '2025-03-15 22:16:33', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2012, '用护胜负情况导出', 2007, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'userGameInfo:userGameInfo:export', '#', 'admin', '2025-03-15 22:16:33', '', NULL, '');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-03-15 21:43:58', 'admin', '2025-03-15 20:28:50', '', '2025-03-15 21:43:58', '管理员');
