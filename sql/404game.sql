...
Source Database       : 404game

Target Server Type    : MYSQL
Target Server Version : 80034
File Encoding         : 65001

Date: 2025-05-30 14:45:30
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='游戏房间聊天记录表';
...
CREATE TABLE `poker_race_info` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '比赛信息id',
  `race_id` int DEFAULT NULL COMMENT '比赛id',
  `player_a` int DEFAULT NULL COMMENT '玩家A',
  `player_b` int DEFAULT NULL COMMENT '玩家B',
  `player_c` int DEFAULT NULL COMMENT '玩家C',
  `player_d` int DEFAULT NULL COMMENT '玩家D',
  `winner_a` int DEFAULT NULL COMMENT '胜者A',
  `winner_b` int DEFAULT NULL COMMENT '胜者B',
  `race_time` datetime DEFAULT NULL COMMENT '比赛时间',
  `winner_score` int DEFAULT NULL COMMENT '赢家积分情况',
  `loser_score` int DEFAULT NULL COMMENT '输家积分情况',
  `status` tinyint(1) DEFAULT '1' COMMENT '记录状态：0-已删除，1-正常',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='历史比赛信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='游戏房间信息表';
...
CREATE TABLE `poker_user_game_info` (
  ...
  `win` int DEFAULT '0' COMMENT '胜场次数',
  `lost` int DEFAULT '0' COMMENT '败场次数',
  `race_num` int DEFAULT '0' COMMENT '比赛场次',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户胜负情况';
...
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部门表';
...
) ENGINE=InnoDB AUTO_INCREMENT=139 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=2049 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '201', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-05-30 00:37:00', 'admin', '2025-03-15 20:28:50', '', '2025-05-30 00:37:00', '管理员');
